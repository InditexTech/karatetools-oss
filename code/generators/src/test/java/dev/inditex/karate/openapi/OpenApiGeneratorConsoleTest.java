...
class OpenApiGeneratorConsoleTest {
  ...
  class Constructor {
    ...
    void when_instance_expect_no_exception() {
      assertThatCode(OpenApiGeneratorConsole::new).doesNotThrowAnyException();
    }
  }
  ...
  class PromptMode {
    ...
    void when_mode_arguments_expect_selected_value(final String mode) throws NoSuchFieldException, SecurityException {
      ...
      mockPrompts.put(OpenApiGeneratorConsole.OPEN_API_GENERATOR_MODE_ID,
          new ListResult(mode));
      ConsoleTestUtils.initConsoleWithMockPrompts(mockPrompts, false);

      final var result = OpenApiGeneratorConsole.promptMode();
    ...
    void when_mode_exception_expect_default_value() throws NoSuchFieldException, SecurityException {
      ...
      assertThat(result).isEqualTo(OpenApiGeneratorConsole.OPEN_API_GENERATOR_MODE_DEFAULT_VALUE);
    }
  }
  ...
  class PromptArtifacts {
    ...
    void when_artifacts_arguments_expect_selected_value(final String selected) throws NoSuchFieldException, SecurityException {
      final HashMap<String, PromtResultItemIF> mockPrompts = new HashMap<>();
      mockPrompts.put(OpenApiGeneratorConsole.OPEN_API_GENERATOR_ARTIFACT_ID,
          new ListResult(selected));
      ConsoleTestUtils.initConsoleWithMockPrompts(mockPrompts, false);

      final var result = OpenApiGeneratorConsole.promptArtifacts(
    ...
    void when_artifacts_empty_expect_default_value() throws NoSuchFieldException, SecurityException {
      final HashMap<String, PromtResultItemIF> mockPrompts = new HashMap<>();
      mockPrompts.put(OpenApiGeneratorConsole.OPEN_API_GENERATOR_ARTIFACT_ID,
          new ListResult(OpenApiGeneratorConsole.OPEN_API_GENERATOR_ARTIFACT_DEFAULT_VALUE));
      ConsoleTestUtils.initConsoleWithMockPrompts(mockPrompts, false);

      final var result = OpenApiGeneratorConsole.promptArtifacts(List.of(), null);

      assertThat(result).isEqualTo(OpenApiGeneratorConsole.OPEN_API_GENERATOR_ARTIFACT_DEFAULT_VALUE);
    }
    ...
    void when_artifacts_null_expect_default_value() throws NoSuchFieldException, SecurityException {
      ...
      final var result = OpenApiGeneratorConsole.promptArtifacts(null, null);
    ...
    void when_artifacts_exception_expect_default_value() throws NoSuchFieldException, SecurityException {
      final HashMap<String, PromtResultItemIF> mockPrompts = new HashMap<>();
      mockPrompts.put(OpenApiGeneratorConsole.OPEN_API_GENERATOR_ARTIFACT_ID, new ListResult(""));
      ConsoleTestUtils.initConsoleWithMockPrompts(mockPrompts, true);
  ...
  class PromptSecondaryArtifacts {
    ...
    void when_secondary_artifacts_arguments_expect_selected_value(final String selected) throws NoSuchFieldException, SecurityException {
      ...
      final var result = OpenApiGeneratorConsole.promptSecondaryArtifacts("Other Artifact",
    ...
    void when_secondary_artifacts_empty_expect_default_value() throws NoSuchFieldException, SecurityException {
      final HashMap<String, PromtResultItemIF> mockPrompts = new HashMap<>();
      mockPrompts.put(OpenApiGeneratorConsole.OPEN_API_GENERATOR_SECONDARY_ARTIFACT_ID,
          new ListResult(OpenApiGeneratorConsole.OPEN_API_GENERATOR_SECONDARY_ARTIFACT_DEFAULT_VALUE));
      ConsoleTestUtils.initConsoleWithMockPrompts(mockPrompts, false);

      final var result = OpenApiGeneratorConsole.promptSecondaryArtifacts("Other Artifact", List.of(), null);

      assertThat(result).isEqualTo(OpenApiGeneratorConsole.OPEN_API_GENERATOR_SECONDARY_ARTIFACT_DEFAULT_VALUE);
    }
    ...
    void when_secondary_artifacts_null_expect_default_value() throws NoSuchFieldException, SecurityException {
      ...
      final var result = OpenApiGeneratorConsole.promptSecondaryArtifacts("Other Artifact", null, null);
    ...
    void when_secondary_artifacts_exception_expect_default_value() throws NoSuchFieldException, SecurityException {
      final HashMap<String, PromtResultItemIF> mockPrompts = new HashMap<>();
      mockPrompts.put(OpenApiGeneratorConsole.OPEN_API_GENERATOR_SECONDARY_ARTIFACT_ID, new ListResult(""));
      ConsoleTestUtils.initConsoleWithMockPrompts(mockPrompts, true);
  ...
  class PromptOpenApi {
    ...
    void when_api_list_arguments_expect_selected_value(final String selected) throws NoSuchFieldException, SecurityException {
      ...
      final var result = OpenApiGeneratorConsole.promptOpenApi(
    ...
    void when_api_list_arguments_select_manual_expect_null(final List<String> list) throws NoSuchFieldException, SecurityException {
      ...
      final var result = OpenApiGeneratorConsole.promptOpenApi(list);
    ...
    void when_api_list_exception_expect_null() throws NoSuchFieldException, SecurityException {
      final HashMap<String, PromtResultItemIF> mockPrompts = new HashMap<>();
      mockPrompts.put(OpenApiGeneratorConsole.OPEN_API_GENERATOR_OPEN_API_FILE_LIST_ID, new ListResult(""));
      ConsoleTestUtils.initConsoleWithMockPrompts(mockPrompts, true);
    ...
    void when_api_input_argument_expect_selected_value(final String selected) throws NoSuchFieldException, SecurityException {
      final HashMap<String, PromtResultItemIF> mockPrompts = new HashMap<>();
      mockPrompts.put(OpenApiGeneratorConsole.OPEN_API_GENERATOR_OPEN_API_FILE_MANUAL_ID,
  ...
  class PromptOperations {
    ...
    void when_operations_arguments_expect_selected_value() throws NoSuchFieldException, SecurityException {
      ...
      final HashMap<String, PromtResultItemIF> mockPrompts = new HashMap<>();
      mockPrompts.put(OpenApiGeneratorConsole.OPEN_API_GENERATOR_OPERATIONS_ID, new CheckboxResult(new HashSet<>(Set.of(operationId))));
      ConsoleTestUtils.initConsoleWithMockPrompts(mockPrompts, false);

      final var result = OpenApiGeneratorConsole.promptOperations(Map.of("BasicApi", List.of(
    ...
    void when_operations_empty_expect_empty() throws NoSuchFieldException, SecurityException {
      final HashMap<String, PromtResultItemIF> mockPrompts = new HashMap<>();
      mockPrompts.put(OpenApiGeneratorConsole.OPEN_API_GENERATOR_OPERATIONS_ID, new CheckboxResult(new HashSet<>(Set.of(""))));
      ConsoleTestUtils.initConsoleWithMockPrompts(mockPrompts, false);
    ...
    void when_operations_null_expect_empty() throws NoSuchFieldException, SecurityException {
      ...
      final var result = OpenApiGeneratorConsole.promptOperations(null);
  ...
  class PromptOperationResponses {
    ...
    void when_operation_responses_single_expect_selected_value() throws NoSuchFieldException, SecurityException {
      ...
      final HashMap<String, PromtResultItemIF> mockPrompts = new HashMap<>();
      mockPrompts.put(OpenApiGeneratorConsole.OPEN_API_GENERATOR_OPERATION_RESPONSE_ID_PREFIX + operation.operation().getOperationId(),
          new CheckboxResult(new HashSet<>(selected)));
      ConsoleTestUtils.initConsoleWithMockPrompts(mockPrompts, false);

      final var result = OpenApiGeneratorConsole.promptOperationResponses(operation, responses);
    ...
    void when_operation_responses_null_expect_empty() throws NoSuchFieldException, SecurityException {
      ...
      final var result = OpenApiGeneratorConsole.promptOperationResponses(operation, null);
  ...
  class PromptTestName {
    ...
    void when_test_name_input_argument_expect_parsed_selected_value(final String selected, final String expected)
      ...
      final var result = OpenApiGeneratorConsole.promptTestName("Test Name");
    ...
    void when_test_name_input_exception_expect_null() throws NoSuchFieldException, SecurityException {
      final HashMap<String, PromtResultItemIF> mockPrompts = new HashMap<>();
      mockPrompts.put(OpenApiGeneratorConsole.OPEN_API_GENERATOR_TEST_NAME_ID, new InputResult(""));
      ConsoleTestUtils.initConsoleWithMockPrompts(mockPrompts, true);
  ...
  class PromptInlineMocks {
    ...
    void when_mode_arguments_expect_selected_value(final Boolean inlineMocks) throws NoSuchFieldException, SecurityException {
      ...
      final var result = OpenApiGeneratorConsole.promptInlineMocks("Inline Mocks");
    ...
    void when_mode_exception_expect_default_value() throws NoSuchFieldException, SecurityException {
      ...
      assertThat(result).isEqualTo(OpenApiGeneratorConsole.OPEN_API_GENERATOR_INLINE_MOCKS_DEFAULT_VALUE);
    }
  }
