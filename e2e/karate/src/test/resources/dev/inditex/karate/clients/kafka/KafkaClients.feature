...
Given def topicB = "dev.inditex.karate.kafka.public.B"
...
Scenario: Kafka Clients Available Operations - Single Topic
...
Scenario: Kafka Clients Available Operations - Multiple Topics
# public void send(final String topic, final Object event)
