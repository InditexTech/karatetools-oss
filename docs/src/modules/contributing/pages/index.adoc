...
Before starting to contribute to the code, you must first sign the ✍️ Contributor License Agreement (CLA).
Detailed instructions on how to proceed can be found [*Contributor License Agreement (CLA)*, window="_blank"](https://github.com/InditexTech/foss/blob/main/CONTRIBUTING.md).
...
* Sign off your commits (`Signed-off-by`) to comply with DCO requirements.
** Configure signoff in your local clone with `git config format.signoff true`.
** You can also configure it globally with `git config --global format.signoff true`.
...
. Make clear and descriptive signed-off commits that explain your changes
