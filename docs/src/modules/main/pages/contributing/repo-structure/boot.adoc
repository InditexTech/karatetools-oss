= Boot module
:description: The karatetools-oss-boot module.
...
....
include::partial$puml/karatetools-oss-boot.puml[]
....
...
....
include::partial$puml/karatetools-oss-boot-integration-tests.puml[]
....
