= Karate test module
:description: The karatetools-oss-karate-test module.
...
....
include::partial$puml/karatetools-oss-karate-test.puml[]
....
...
----
include::example$contributing/e2e-karate-tree.txt[lines="1..14"]
----
include::example$contributing/e2e-karate-tree-callouts-java.txt[]

* *src/test/resources*: Base and Config files
+
[source,subs="attributes+"]
----
include::example$contributing/e2e-karate-tree.txt[lines="1..5,15,101..123"]
----
include::example$contributing/e2e-karate-tree-callouts-resources-config.txt[]

* *src/test/resources/dev/inditex/karate*: Tests related to Karate Tools features
+
[source,subs="attributes+"]
----
include::example$contributing/e2e-karate-tree.txt[lines="1..5,15,45..65"]
----
include::example$contributing/e2e-karate-tree-callouts-resources-karate-tests.txt[]
...
[source,subs="attributes+"]
----
include::example$contributing/e2e-karate-tree.txt[lines="1..5,15..44"]
----
include::example$contributing/e2e-karate-tree-callouts-resources-apis.txt[]

* *src/test/resources/dev/inditex/karate/karatetools-openapi-test/xxx-api-rest-stable*: REST Api tests
+
[source,subs="attributes+"]
----
include::example$contributing/e2e-karate-tree.txt[lines="1..5,15,45..47,66..100"]
----
include::example$contributing/e2e-karate-tree-callouts-resources-api-tests.txt[]
