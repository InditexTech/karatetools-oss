= Archetype module
:description: The karatetools-oss-archetype module.
...
....
include::partial$puml/karatetools-oss-archetype.puml[]
....
...
----
include::example$contributing/archetype-tree.txt[]
----
include::example$contributing/archetype-tree-callouts.txt[]
