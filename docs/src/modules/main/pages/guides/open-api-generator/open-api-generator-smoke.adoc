...
[source,plaintext,subs="+attributes"]
----
include::example$open-api-generator/open-api-generator-smoke-select.txt[]
----

image::open-api-generator/open-api-generator-cmd-smoke.png[role="no-border, zoom-in"]
...
[source,plaintext,subs="+attributes"]
----
include::example$open-api-generator/open-api-generator-smoke.txt[]
? Enter the location of the Open Api definition
  Enter Manually
