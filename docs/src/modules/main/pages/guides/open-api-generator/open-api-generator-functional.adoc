...
** test data
** verification steps
** (if applicable) include steps for initial data (jdbc, mongodb, kafka, jms) using the xref:guides/clients/overview.adoc[🛠️ Karate Clients]
** (if applicable) include steps for additional checks (jdbc, mongodb, kafka, jms) using the xref:guides/clients/overview.adoc[🛠️ Karate Clients]
...
----
include::example$open-api-generator/open-api-generator-functional-select.txt[]
----

image::open-api-generator/open-api-generator-cmd-functional.png[role="no-border, zoom-in"]
...
image::open-api-generator/open-api-generator-cmd-api.png[role="no-border, zoom-in"]
...
image::open-api-generator/open-api-generator-cmd-artifact.png[role="no-border, zoom-in"]
...
image::open-api-generator/open-api-generator-cmd-testname.png[role="no-border, zoom-in"]
...
If *inline mocks* is selected the the *open-api-generator* will include in the test the `Background Steps` to load the mocks. The mocks should be generated following the instructions in *xref:guides/open-api-generator/open-api-generator-mock.adoc[Karate Open Api Generator - Mock Data]* also indicating that the generated mocks are *inline* and related to this functional test.
...
image::open-api-generator/open-api-generator-cmd-inlinemocks.png[role="no-border, zoom-in"]
