...
image::open-api-generator/open-api-generator-mock-server.png[role="no-border, zoom-in"]
...
image::open-api-generator/open-api-generator-mock-template.png[role="no-border, zoom-in"]
...
image::open-api-generator/open-api-generator-mock-process.png[role="no-border, zoom-in"]
...
NOTE: If the project has been generated using the xref:guides/archetype/overview.adoc[Karate Tools Archetype] the project will already contain all the files needed for the execution of the karate mock server.
...
----
include::example$open-api-generator/open-api-generator-mock-select.txt[]
----

image::open-api-generator/open-api-generator-cmd-mock.png[role="no-border, zoom-in"]
...
[source,plaintext,subs="+attributes"]
----
include::example$open-api-generator/open-api-generator-mock.txt[]
? Enter the location of the Open Api definition
  Enter Manually
...
image::open-api-generator/open-api-generator-cmd-api-external.png[role="no-border, zoom-in"]
...
image::open-api-generator/open-api-generator-cmd-api-manual.png[role="no-border, zoom-in"]
...
image::open-api-generator/open-api-generator-cmd-methods.png[role="no-border, zoom-in"]
...
image::open-api-generator/open-api-generator-cmd-responsecode.png[role="no-border, zoom-in"]
...
image::open-api-generator/open-api-generator-cmd-artifact-mocks.png[role="no-border, zoom-in"]
...
* The functional test should have been generated following the instructions in *xref:guides/open-api-generator/open-api-generator-functional.adoc[Karate Open Api Generator - Functional Test]* also indicating that the generated functional test will *include inline mocks*.
...
image::open-api-generator/open-api-generator-cmd-inline.png[role="no-border, zoom-in"]
...
image::open-api-generator/open-api-generator-cmd-inline-artifact.png[role="no-border, zoom-in"]
...
image::open-api-generator/open-api-generator-cmd-inline-testname.png[role="no-border, zoom-in"]
