...
include::partial$configuration/auth-jwt-config.adoc[]
...
----
include::example$configuration/auth-jwt-settings.yml[]
----
...
[source,yaml,subs="+attributes"]
----
include::example$configuration/auth-jwt-overwrite.yml[]
----

== Error Management

include::partial$configuration/auth-jwt-errors.adoc[]
