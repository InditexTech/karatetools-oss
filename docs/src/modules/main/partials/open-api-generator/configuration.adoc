...
----
include::example$open-api-generator/open-api-generator-pom.xml[]
----
====
...
TIP: Override the default permanently in your `pom.xml` `<properties>`, or at the command line per execution (see xref:guides/open-api-generator/overview.adoc#execution[Open API Generator - Execution]).
