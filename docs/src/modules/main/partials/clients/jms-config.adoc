...
NOTE: If the project has been generated using the xref:guides/archetype/overview.adoc[Karate Tools Archetype] the archetype would have prompted for the creation of the configuration files.
